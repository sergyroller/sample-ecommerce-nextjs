...
export default async function Default({ params }: Props) {
  ...
  const subtitles: Record<Category, string> = {
    ...
    women:
      'Descubre nuestra colección de ropa para mujer, diseñada para realzar tu estilo. Con opciones para el día a día o eventos especiales, aquí encontrarás moda versátil y actual.',
    ...
    unisex:
      'Moda inclusiva para todos los estilos y edades. Encuentra prendas versátiles y modernas para cada miembro de la familia en un solo lugar.',
  };
